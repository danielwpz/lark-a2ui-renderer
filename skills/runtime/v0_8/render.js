            ...
            columns: [
                {
                    ...
                    vertical_spacing: "0px",
                    padding: `${padding}px`,
                    background_style: backgroundColor == null ? "default" : registerColorStyle(context, backgroundColor),
                    elements: renderChildren(context, childIds),
                },
            ],
        },
...
function containsLarkFormElementNode(context, componentId, seen = new Set()) {
    ...
    return readOptionalExplicitChildren(component.props.children).some((childId) => containsLarkFormElementNode(context, childId, seen));
}
